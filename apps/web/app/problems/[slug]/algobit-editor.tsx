...
import {
	UserSnippetContext,
	type UserSnippetStatus,
} from "./UserSnippetContext";
...
export const AlgobitEditor = ({ problem }: { problem: any }) => {
	...
	return (
		<UserSnippetContext.Provider
			value={{ userSnippetStatus, setUserSnippetStatus }}
		>
			<SubmissionResponseContext.Provider
				value={{ isSubmissionResponse, setIsSubmissionResponse }}
			>
				<RunResponseContext.Provider
					value={{ isRunResponse, setIsRunResponse }}
				>
					<div className="min-h-screen bg-[#252a31]">
						...
						>
							<ResizablePanel
								...
								minSize={4}
								maxSize={96}
								className="border-[1px] rounded-lg border-gray-500"
							>
