...
export default async function SubmissionRoutes(fastify: FastifyInstance, _option: FastifyPluginOptions){
    ...
    fastify.patch("/:id", submissionController.updateOne.bind(submissionController));
}
